...
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_roles_assigment" DROP CONSTRAINT IF EXISTS "inferno_roles_assigment_user_user_id_fkey";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_roles_assigment" DROP CONSTRAINT IF EXISTS "inferno_roles_assigment_authority_fkey";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_roles_assigment" DROP CONSTRAINT IF EXISTS "inferno_roles_assigment_assigned_role_id_fkey";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_person" DROP CONSTRAINT IF EXISTS "inferno_person_user_id_fkey";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_address" DROP CONSTRAINT IF EXISTS "FK45uctwmpfedlp9tf5l22nepgh";
DROP TRIGGER IF EXISTS "update_inferno_users_modification" ON "inferno_authorization_schema"."inferno_users";
DROP TRIGGER IF EXISTS "update_inferno_roles_modification" ON "inferno_authorization_schema"."inferno_roles";
DROP TRIGGER IF EXISTS "update_inferno_roles_assigment_modification" ON "inferno_authorization_schema"."inferno_roles_assigment";
DROP TRIGGER IF EXISTS "update_inferno_person_modification" ON "inferno_authorization_schema"."inferno_person";
DROP TRIGGER IF EXISTS "update_inferno_address_modification" ON "inferno_authorization_schema"."inferno_address";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_roles" DROP CONSTRAINT IF EXISTS "uk_nqbi2i1pc82apmu8dto91ob21";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_users" DROP CONSTRAINT IF EXISTS "uk_as31qd8m2kj6mg5a7hdkhfokk";
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_users" DROP CONSTRAINT IF EXISTS "inferno_users_pkey" CASCADE;
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_roles" DROP CONSTRAINT IF EXISTS "inferno_roles_pkey" CASCADE;
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_roles_assigment" DROP CONSTRAINT IF EXISTS "inferno_roles_assigment_pkey" CASCADE;
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_person" DROP CONSTRAINT IF EXISTS "inferno_person_pkey" CASCADE;
ALTER TABLE IF EXISTS ONLY "inferno_authorization_schema"."inferno_address" DROP CONSTRAINT IF EXISTS "inferno_address_pkey" CASCADE;
DROP TABLE IF EXISTS "inferno_authorization_schema"."inferno_users";
DROP SEQUENCE IF EXISTS "inferno_authorization_schema"."inferno_users_seq";
DROP TABLE IF EXISTS "inferno_authorization_schema"."inferno_roles_assigment";
DROP SEQUENCE IF EXISTS "inferno_authorization_schema"."inferno_user_roles_assigment_seq";
DROP TABLE IF EXISTS "inferno_authorization_schema"."inferno_roles";
DROP SEQUENCE IF EXISTS "inferno_authorization_schema"."inferno_roles_seq";
DROP TABLE IF EXISTS "inferno_authorization_schema"."inferno_person";
DROP SEQUENCE IF EXISTS "inferno_authorization_schema"."inferno_person_seq";
DROP TABLE IF EXISTS "inferno_authorization_schema"."inferno_address";
DROP SEQUENCE IF EXISTS "inferno_authorization_schema"."inferno_address_seq";
DROP FUNCTION IF EXISTS "inferno_authorization_schema"."update_modified_timestamp_column"();
--DROP SCHEMA IF EXISTS "inferno_authorization_schema";
--
...
--
-- Name: update_modified_timestamp_column(); Type: FUNCTION; Schema: inferno_authorization_schema; Owner: postgres
--
...
--
-- Name: inferno_roles_assigment inferno_roles_assigment_assignedRole_id_fkey; Type: FK CONSTRAINT; Schema: inferno_authorization_schema; Owner: inferno_init_db_admin
--
