...
public class UserDTO implements UserDetails, Authentication, Principal {
     ...
     * @param roles
     */
    public UserDTO(String username, String password, boolean active, LocalDateTime validTo, LocalDateTime created,
	    Set<UserRolesDTO> roles) {
	this.username = username;
	this.password = password;
	this.active = active;
	...
	builder.append("authenticated=").append(authenticated).append(", accountExpired=").append(accountExpired)
		.append(", accountLocked=").append(accountLocked).append(", credentialsExpired=")
		.append(credentialsExpired).append("]");
